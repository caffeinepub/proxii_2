...
function TaskCardComponent({ task, index: index2 }) {
  var _a2;
  const telegramHandle = ((_a2 = task.telegram_id) == null ? void 0 : _a2.replace(/^@/, "")) ?? "";
  const telegramUrl = telegramHandle ? `https://t.me/${telegramHandle}?text=${encodeURIComponent(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      children: [
        ...
        telegramHandle ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            type: "button",
            "data-ocid": `tasks.item.${index2}.button`,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col items-center justify-center px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-foreground text-center", children: "Task Posted! 🎉" }),
...
function ProfileScreen({
  ...
  const initials = fields.fullName.trim().split(" ").filter(Boolean).slice(0, 2).map((w) => w[0].toUpperCase()).join("");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-4 py-8 pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: fields.fullName || "Complete Your Profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Fill in your details to start posting and completing tasks." })
    ] }),
    profileAlreadySaved && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    status === "success" && !profileAlreadySaved && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": "profile.success_state",
        className: "flex items-center gap-3 rounded-xl px-4 py-3 mb-5 text-sm font-medium",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              className: `w-full border-0 text-white font-semibold rounded-xl h-11 mt-2 ${profileAlreadySaved ? "opacity-50 cursor-not-allowed" : "glow-button purple-gradient"}`,
              style: {
                background: profileAlreadySaved ? "oklch(0.30 0.04 265)" : void 0,
                boxShadow: profileAlreadySaved ? "none" : void 0
              },
              children: status === "sending" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 mr-2 animate-spin" }),
                "Saving..."
              ] }) : profileAlreadySaved ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: value })
            ]
          },
          label
        ))
...
function App() {
  ...
  const [profileSaved, setProfileSaved] = reactExports.useState(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col min-h-screen", children: [
      ...
      activeTab === "post" && /* @__PURE__ */ jsxRuntimeExports.jsx(PostTaskScreen, {}),
