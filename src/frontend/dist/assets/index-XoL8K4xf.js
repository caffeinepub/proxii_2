...
const TASKS = [
  {
    ...
    description: "Need someone to drop off laundry at the dhobi and pick it up by evening.",
    author: "Arjun M.",
    tag: "Errands"
  },
  {
    ...
    description: "Need help debugging my ML project code — deadline is tomorrow!",
    author: "Priya S.",
    tag: "Academic"
  },
  {
    ...
    description: "Pick up 2kg rice and Maggi from the store near the main gate.",
    author: "Rohit K.",
    tag: "Errands"
  },
  {
    ...
    description: "Scan and convert 30 pages of handwritten notes to PDF format.",
    author: "Sneha R.",
    tag: "Academic"
  },
  {
    ...
    description: "Come with me to the bike repair shop nearby for safety & company.",
    author: "Dev P.",
    tag: "Transport"
  },
  {
    ...
    description: "Print and spiral bind my final year project report — 80 pages.",
    author: "Kavya T.",
    tag: "Printing"
  }
];
    ...
    "article",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground leading-snug flex-1", children: task.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.60 0 0)" }, children: [
          "Posted by ",
          task.author
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 py-8 max-w-3xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: TASKS.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskCardComponent, { task, index: i + 1 }, task.id))
      }
    )
  ] });
}
...
function PostTaskScreen() {
  ...
  const [lastTitle, setLastTitle] = reactExports.useState("");
  const [lastPrice, setLastPrice] = reactExports.useState("");
  const [lastLocation, setLastLocation] = reactExports.useState("");
  const [lastDeadline, setLastDeadline] = reactExports.useState("");
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: lastLocation })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Deadline" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: lastDeadline })
                ] })
              ]
            }
          ),
...
function ExploreScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedTasksSection, {}),
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col min-h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { activeTab, onTabChange: setActiveTab }),
      activeTab === "explore" && /* @__PURE__ */ jsxRuntimeExports.jsx(ExploreScreen, {}),
      activeTab === "post" && /* @__PURE__ */ jsxRuntimeExports.jsx(PostTaskScreen, {}),
      activeTab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileScreen, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { active: activeTab, onTabChange: setActiveTab })
  ] });
}
