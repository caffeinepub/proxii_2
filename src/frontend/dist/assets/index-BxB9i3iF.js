...
async function loginUser(userId, passwordHash) {
  const res = await fetch(
    `${SHEETDB}/search?sheet=users&user_id=${encodeURIComponent(userId)}`
  );
  if (!res.ok) return null;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at center, oklch(0.45 0.22 295 / 0.18) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Decorative animated grid" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "100%", height: "100%", fill: "url(#curvy-grid-1)" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Decorative animated grid overlay" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "pattern",
                {
                  id: "curvy-grid-2",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "100%", height: "100%", fill: "url(#curvy-grid-2)" })
            ]
          }
        )
      ]
...
function Header({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 glass-nav px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto flex items-center justify-between h-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden sm:flex items-center gap-5 text-sm", children: ["explore", "post", "profile"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        children: tab === "post" ? "Post Task" : tab
      },
      tab
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function HeroSection({ onExplore }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative text-center pt-16 pb-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3", style: { color: "oklch(0.70 0.22 295)" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.80 0.18 295)" }, children: "Beta — Campus-only network" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl font-extrabold leading-tight mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "purple-gradient-text", children: "Proxii Hub:" }),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Your Campus, Your Community, Your Local Marketplace" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg mb-8 max-w-xl mx-auto", children: "Post tasks, find help, and get things done — all within your college campus." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        type: "button",
...
function TaskCardComponent({
  ...
  const catStyle = task.category ? CATEGORY_STYLES[task.category] ?? CATEGORY_STYLES.Other : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      "data-ocid": `tasks.item.${index2}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground leading-snug flex-1", children: task.task_name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        catStyle && task.category ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: task.Description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [
          ...
          task.deadline ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "oklch(0.60 0 0)" }, children: [
            "Due: ",
            task.deadline
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "oklch(0.55 0.10 295)" }, children: isMyTask ? "Your task" : "Tap to view details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ExternalLink,
            {
...
function TaskDetailModal({
  ...
  var _a2, _b2, _c2, _d2;
  const [posterInfo, setPosterInfo] = reactExports.useState(null);
  const [_posterHistory, setPosterHistory] = reactExports.useState([]);
  const [modalFeedbackRows, setModalFeedbackRows] = reactExports.useState([]);
  const [posterLoading, setPosterLoading] = reactExports.useState(true);
  const [requestSent, setRequestSent] = reactExports.useState(() => {
    if (!currentUserId || !task.applicants) return false;
    return task.applicants.split(",").map((s) => s.trim()).includes(currentUserId);
  });
  ...
  reactExports.useEffect(() => {
    ...
    Promise.all([
      ...
      setPosterHistory(
        history.filter(
          (h) => h.worker_id === ((user == null ? void 0 : user.user_id) ?? task.user_id_origintor)
        )
      );
  ...
  const ratings = modalFeedbackRows.filter(
    (r2) => r2.worker_id === ((posterInfo == null ? void 0 : posterInfo.user_id) ?? task.user_id_origintor) && r2.rating && !Number.isNaN(Number.parseFloat(r2.rating))
  ).map((r2) => Number.parseFloat(r2.rating));
  ...
  function renderStars(rating) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-0.5", children: [
      starKeys.map((k, i) => {
        if (i < full)
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.80 0.15 75)" }, children: "★" }, k);
        if (i === full && half)
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.80 0.15 75)" }, children: "½" }, k);
        return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.35 0 0)" }, children: "★" }, k);
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", style: { color: "oklch(0.70 0 0)" }, children: [
        "(",
        rating.toFixed(1),
        ")"
      ] })
  ...
  async function handleDiscussChat() {
    ...
    setChatLoading(true);
    try {
      let handle = (_a3 = posterInfo == null ? void 0 : posterInfo.telegram_id) == null ? void 0 : _a3.replace(/^@/, "");
      if (!handle && task.user_id_origintor) {
        const user = await fetchUserById(task.user_id_origintor);
        handle = (_b3 = user == null ? void 0 : user.telegram_id) == null ? void 0 : _b3.replace(/^@/, "");
      }
      if (handle) {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        task.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "text-xs font-medium",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "oklch(0.80 0 0)" }, children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3 inline mr-1" }),
                            task.location
                          ] })
                        ] }),
                        task.deadline && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "text-xs font-medium",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "oklch(0.80 0 0)" }, children: task.deadline })
                        ] }),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            children: "Poster Profile"
                          }
                        ),
                        posterLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 py-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            LoaderCircle,
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "oklch(0.55 0 0)" }, children: "Loading poster info..." })
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: ((_b2 = (_a2 = posterInfo == null ? void 0 : posterInfo.full_name) == null ? void 0 : _a2.charAt(0)) == null ? void 0 : _b2.toUpperCase()) ?? ((_d2 = (_c2 = task.user_id_origintor) == null ? void 0 : _c2.charAt(0)) == null ? void 0 : _d2.toUpperCase()) ?? "?"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                ...
                                children: (posterInfo == null ? void 0 : posterInfo.full_name) ?? task.user_id_origintor ?? "Unknown"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "span",
                              {
                                ...
                                children: [
                                  "@",
                                  (posterInfo == null ? void 0 : posterInfo.user_id) ?? task.user_id_origintor
                                ]
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-0.5 flex-wrap", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  className: "text-xs",
                                  style: { color: "oklch(0.60 0 0)" },
                                  children: avgRating !== null ? renderStars(avgRating) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Unrated" })
                                }
                              ),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "span",
                  ...
                  isMyTask ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      "button",
                      {
                        ...
                        onClick: async () => {
                          ...
                          if (!requestSent) {
                            ...
                            try {
                              const existing = task.applicants ? task.applicants.trim() : "";
                              const ids = existing ? existing.split(",").map((s) => s.trim()) : [];
                            ...
                            try {
                              const existing = task.applicants ? task.applicants.trim() : "";
                              const ids = existing ? existing.split(",").map((s) => s.trim()).filter((id) => id !== currentUserId) : [];
                              const newApplicants = ids.join(",");
                              await patchTask(task.task_id, {
                                applicants: newApplicants
                              });
                        ...
                        style: requestSent ? {
                          ...
                          gap: "0.5rem",
                          transition: "all 0.2s",
                          background: "linear-gradient(135deg, oklch(0.55 0.22 295), oklch(0.50 0.24 310))",
                          color: "#fff",
                          boxShadow: "0 0 20px oklch(0.45 0.22 295 / 0.35)"
                        },
                        children: requestLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { opacity: 0.7 }, children: "Sending..." }) : requestSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          chatLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-4 h-4" }),
                          "Discuss on Chat"
                        ]
                      }
                    )
...
function WhyProxiiSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 py-8 max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl sm:text-2xl font-bold text-center mb-8", children: "Why Proxii Hub?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4", children: WHY_FEATURES.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-foreground", children: f.label }),
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-8 pb-28 px-4 max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-sm purple-gradient-text", children: "Proxii Hub" }),
...
function CreateAccountForm({ onAuth }) {
  ...
  function handleAutoGenerate() {
    var _a2;
    const firstName = ((_a2 = fields.fullName.trim().split(/\s+/)[0]) == null ? void 0 : _a2.toLowerCase()) || "user";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Label,
        {
          ...
          children: [
            "Full Name ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.65 0.22 15)" }, children: "*" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Click the icon to auto-generate from your name" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Label,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "To contact your peer" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Label,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Where you'll be credited for helping your peer" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Label,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          style: {
            ...
            color: fields.upiPlatform ? "oklch(0.85 0.04 265)" : "oklch(0.55 0.04 265)",
            borderRadius: "0.75rem",
            height: "2.75rem",
            padding: "0 1rem",
            width: "100%",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select your UPI app" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "gpay", children: "Google Pay (GPay)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "phonepe", children: "PhonePe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "paytm", children: "Paytm" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "amazonpay", children: "Amazon Pay" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "bhim", children: "BHIM" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cred", children: "CRED" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "growwpay", children: "Groww Pay" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "navi", children: "Navi" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "mobikwik", children: "MobiKwik" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Your college unique ID" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Label,
...
function LoginForm({ onAuth }) {
  const [fields, setFields] = reactExports.useState({ username: "", password: "" });
  const [status, setStatus] = reactExports.useState("idle");
  const [errorMsg, setErrorMsg] = reactExports.useState("");
  function handleChange(e) {
    const { name, value } = e.target;
...
function WelcomeScreen({ onAuth }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center px-4 py-12 relative z-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full pointer-events-none",
        style: {
          background: "radial-gradient(ellipse, oklch(0.45 0.22 295 / 0.12) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          ...
          boxShadow: "0 0 60px -12px oklch(0.45 0.22 295 / 0.25), 0 25px 50px -12px oklch(0 0 0 / 0.5)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-extrabold purple-gradient-text tracking-tight", children: "Proxii Hub" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Your campus marketplace" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ["login", "create"].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    background: view === v ? "oklch(0.45 0.22 295 / 0.25)" : "transparent",
                    color: view === v ? "oklch(0.82 0.20 295)" : "oklch(0.55 0 0)",
                    border: view === v ? "1px solid oklch(0.50 0.18 295 / 0.4)" : "1px solid transparent"
                  },
                  children: v === "login" ? "Login" : "Create Account"
                },
                v
              ))
            }
          ),
          view === "login" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoginForm, { onAuth }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CreateAccountForm, { onAuth })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-6 text-center", children: "Campus-only marketplace · Private by design" })
  ] });
}
function PostTaskScreen({
  ...
  const [fields, setFields] = reactExports.useState(emptyPost);
  const [status, setStatus] = reactExports.useState("idle");
  const [errorMsg, setErrorMsg] = reactExports.useState("");
  const [lastTask, setLastTask] = reactExports.useState(emptyPost);
  function handleChange(e) {
    const { name, value } = e.target;
    setStatus("idle");
    setFields((prev) => ({ ...prev, [name]: value }));
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      onTaskPosted == null ? void 0 : onTaskPosted(newTask);
      setLastTask(fields);
      setStatus("success");
      setTimeout(() => {
        onGoToExplore();
  ...
  if (status === "success") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col items-center justify-center px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-foreground text-center", children: "Task Live! 🎉" }),
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: lastTask.location })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Deadline" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: lastTask.deadline })
                ] })
              ]
            }
          ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-4 py-8 pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Post a Task" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Let campus helpers come to you." })
    ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Assignment", children: "Assignment" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Notes/Books", children: "Notes/Books" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Delivery/Pick-up", children: "Delivery/Pick-up" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Tech Support", children: "Tech Support" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Lab Work", children: "Lab Work" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Other", children: "Other" })
                ]
              }
            )
...
function PostedTaskCard({ task, index: index2 }) {
  const [selectedPerformer, setSelectedPerformer] = reactExports.useState(
    null
  );
  const [selectingId, setSelectingId] = reactExports.useState(null);
  const [successId, setSuccessId] = reactExports.useState(null);
  const [acceptingId, setAcceptingId] = reactExports.useState(null);
  const applicantList = task.applicants ? task.applicants.split(",").map((s) => s.trim()).filter(Boolean) : [];
  async function handleSelect(applicantId) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `profile.posted.item.${index2 + 1}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: task.task_name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-1", children: [
          ...
          applicantList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "No applicants yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1.5 mt-1.5", children: applicantList.map((applicantId) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                successId === applicantId || selectedPerformer === applicantId || task.worker_id === applicantId ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                ) : acceptingId === applicantId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        cursor: selectingId === applicantId ? "not-allowed" : "pointer"
                      },
                      children: selectingId === applicantId ? "Confirming..." : "✓ Confirm"
                    }
                  )
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      color: "oklch(0.72 0.15 295)",
                      background: "transparent",
                      cursor: !!task.worker_id || !!selectedPerformer ? "not-allowed" : "pointer",
                      opacity: !!task.worker_id || !!selectedPerformer ? 0.4 : 1
                    },
                    children: "Accept"
                  }
                )
...
function ProfileScreen({
  ...
  const [userRow, setUserRow] = reactExports.useState(null);
  ...
  const cachedRef = reactExports.useRef(null);
  const [taskHistory, setTaskHistory] = reactExports.useState([]);
  const [allTasks, setAllTasks] = reactExports.useState([]);
  const [feedbackRows, setFeedbackRows] = reactExports.useState([]);
  ...
  reactExports.useEffect(() => {
    ...
    fetchUserById(userId).then((row) => {
      ...
      setUserRow(row);
    }).catch(() => setFetchError("Failed to load profile. Please try again.")).finally(() => setLoading(false));
  }, [userId, onLogout]);
  reactExports.useEffect(() => {
    if (!userId) return;
    setStatsLoading(true);
    Promise.all([fetchTasks(), fetchTaskHistory(), fetchFeedback()]).then(([tasks, history, feedback]) => {
      setAllTasks(tasks);
  ...
  const ratings = feedbackRows.filter(
    (r2) => r2.worker_id === userId && r2.rating && !Number.isNaN(Number.parseFloat(r2.rating))
  ).map((r2) => Number.parseFloat(r2.rating));
  const avgRating = ratings.length > 0 ? ratings.reduce((a, b) => a + b, 0) / ratings.length : null;
  function renderStars(rating) {
    const full = Math.floor(rating);
  ...
  const displayName = (userRow == null ? void 0 : userRow.full_name) || "";
  const initials = displayName.trim().split(" ").filter(Boolean).slice(0, 2).map((w) => w[0].toUpperCase()).join("");
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Loading your profile..." })
        ]
      }
    ) });
  }
  if (fetchError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "profile.error_state", className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CircleX,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: fetchError })
    ] }) });
  }
  const profileComplete = userRow ? isProfileComplete(userRow) : false;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-4 py-8 pb-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          profileComplete && !isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Lock,
            {
              className: "w-4 h-4",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-medium", children: profileComplete && !isEditing ? `@${userId}` : "Your Profile" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: initials ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: displayName || userId }),
        profileComplete && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
      ...
      profileComplete && !isEditing ? (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                [
                  { label: "FULL NAME", value: (userRow == null ? void 0 : userRow.full_name) || "—" },
                  { label: "USERNAME", value: `@${userId}` },
                  {
                    label: "TELEGRAM",
                    value: (userRow == null ? void 0 : userRow.telegram_id) ? `@${userRow.telegram_id}` : "—"
                  },
                  { label: "STUDENT ID", value: (userRow == null ? void 0 : userRow.student_id) || "—" }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                [
                  { label: "PHONE NUMBER", value: (userRow == null ? void 0 : userRow.phone_number) || "—" },
                  { label: "UPI ID", value: (userRow == null ? void 0 : userRow.upi_id) || "—" },
                  { label: "UPI TYPE", value: (userRow == null ? void 0 : userRow.upi_type) || "—" },
                  { label: "GMAIL", value: (userRow == null ? void 0 : userRow.email_id) || "—" }
                ].map(({ label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(0.45 0.22 295), oklch(0.70 0.25 295))"
              },
              children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { className: "w-4 h-4 mr-1.5" }),
                  "Go to Hub"
                ]
              }
            ),
        ...
        "form",
        {
          ...
          children: [
            !profileComplete && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center -mt-1 mb-2", children: "Fill in your details to start posting and completing tasks." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "No @ symbol needed" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Label,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: saveStatus === "sending" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 mr-2 animate-spin" }),
                    "Saving..."
      ...
      (() => {
        ...
        const activeApplied = allTasks.filter(
          (t) => {
            var _a2;
            return t.user_id_origintor !== userId && !t.worker_id && ((_a2 = t.applicants) == null ? void 0 : _a2.split(",").map((s) => s.trim()).includes(userId));
          }
        );
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              statsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-2", children: "Loading..." }) : myActivity.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-3", children: "No active tasks. Check the Explore Hub to find work!" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: myActivity.map(({ task, role }) => {
                const badgeStyle = role === "Hiring" ? {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground truncate", children: task.task_name }),
                      ...
                      role === "Hiring" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-xs",
                          style: { color: "oklch(0.55 0.05 295)" },
                          children: !task.applicants || task.applicants.split(",").filter(Boolean).length === 0 ? "Waiting for Applicants" : !task.worker_id ? `${task.applicants.split(",").filter((s) => s.trim()).length} Applicant(s) Found` : `Performer: @${task.worker_id}`
                        }
                      ),
                      role === "Working" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-xs",
                          style: {
                            color: task.payment_status === "Held by Admin" ? "oklch(0.68 0.18 145)" : "oklch(0.55 0 0)"
                          },
                          children: task.payment_status === "Held by Admin" ? "✅ Start Working!" : task.payment_status === "Pending" ? "Awaiting Admin Verification..." : task.status
                        }
                      ),
                      role === "Applied" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-xs",
                          style: { color: "oklch(0.55 0 0)" },
                          children: "Request sent — waiting for poster"
                        }
                      )
                    ] })
                  },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            statsLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-2", children: "Loading stats..." }),
            [
              {
                label: "Tasks Posted",
            ...
            ].map(({ label, value, modal }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between py-2 px-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Rating" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: avgRating !== null ? renderStars(avgRating) : "Unrated" })
            ] })
          ]
        }
      )
    ] }),
    activeModal === "posted" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: modalOverlay,
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground", children: "My Posted Tasks" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: postedTasksDeduped.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-6", children: "No tasks found yet. Start by posting one!" }) : postedTasksDeduped.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    PostedTaskCard,
                    {
                      task: t,
                      index: i
    ...
    activeModal === "completed" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: modalOverlay,
        onClick: () => setActiveModal(null),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground", children: "Earnings History" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "overflow-y-auto flex-1 space-y-2 pr-1",
                  style: { maxHeight: "55vh" },
                  children: completedTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-6", children: "No completed tasks yet. Help someone out!" }) : completedTasks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: t.task_name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t.completion_date || "—" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              style: {
                                color: t.payment_status === "Paid Out" ? "oklch(0.68 0.18 145)" : "oklch(0.65 0 0)"
                              },
                              children: t.payment_status || "Pending"
                            }
                          )
                        ] })
                      ]
    ...
    activeModal === "earned" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: modalOverlay,
        onClick: () => setActiveModal(null),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground", children: "Total Earned" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: paidOutTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-6", children: "No paid out tasks yet." }) : paidOutTasks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground", children: t.task_name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                            className: "text-sm font-bold",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center pt-2 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-muted-foreground", children: "Total" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
...
function BottomNav({
  ...
  const tabs = [
    ...
    { id: "post", icon: CirclePlus, label: "Post Task" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-md mx-auto flex items-center justify-around", children: tabs.map((tab) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              isPost ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "w-12 h-12 rounded-full flex items-center justify-center glow-button",
                  style: {
                    background: isActive ? "linear-gradient(135deg, oklch(0.45 0.22 295), oklch(0.70 0.25 295))" : "linear-gradient(135deg, oklch(0.38 0.20 295), oklch(0.60 0.22 295))",
                    boxShadow: isActive ? "0 0 20px -4px oklch(0.60 0.22 295 / 0.7)" : "none"
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "w-6 h-6 text-white" })
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                tab.icon,
                {
...
function ExploreScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, { onExplore: () => {
    } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 py-8 max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl sm:text-2xl font-bold text-center mb-6", children: "Featured Campus Tasks & Listings" }),
      loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Loading campus tasks..." })
          ]
        }
      ),
      !loading && fetchError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
      ...
      !loading && !fetchError && tasks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          "data-ocid": "tasks.empty_state",
          className: "text-center py-16 text-muted-foreground text-sm",
          children: "No tasks found. Be the first to post one!"
        }
      ),
      !loading && !fetchError && tasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: tasks.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            TaskCardComponent,
            {
              task,
              index: i + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhyProxiiSection, {}),
...
function App() {
  ...
  const [tasksLoading, setTasksLoading] = reactExports.useState(false);
  const [tasksFetched, setTasksFetched] = reactExports.useState(false);
  const [fetchError, setFetchError] = reactExports.useState("");
  reactExports.useEffect(() => {
    if (!tasksFetched) {
  ...
  if (!userId) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeScreen, { onAuth: handleAuth })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedBackground, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col min-h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { activeTab, onTabChange: handleTabChange }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { active: activeTab, onTabChange: handleTabChange })
  ] });
}
